...
using P03_FootballBetting.Data.Models.Configuration;
using System;
...
namespace P03_FootballBetting.Data
{
    public class FootballBettingContext : DbContext
    {
        ...
        public DbSet<Bet> PlayerStatistics { get; set; }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder
                    .UseSqlServer("Server=DESKTOP-D1G8VKM\\SQLEXPRESS;Database=FootballBetting;Integrated Security=True;");
            }
        }
